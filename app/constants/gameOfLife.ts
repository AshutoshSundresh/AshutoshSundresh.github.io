...
export const GAME_OF_LIFE_CONFIG = {
  ...
  // Trail configuration
  maxTrailAge: 30, // Number of generations to show trail
  ...
  trail: {
    fadeExponent: 1.5, // Exponent for fade curve (lower = more linear fade)
    maxOpacity: 0.25, // Maximum opacity for trail (0-1)
    sizeRange: {
