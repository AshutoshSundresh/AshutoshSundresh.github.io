    ...
    <DndContext onDragEnd={handleDragEnd}>
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 [@media(max-width:767px)_and_(max-height:800px)]:gap-1 gap-4 md:gap-4 lg:gap-6 place-items-center w-full px-4 lg:max-w-[900px] mx-auto">
        ...
        <DraggableCard id="card1" position={positions.card1} isDraggingDisabled={isMobile}>
          <div className="backdrop-blur-xl bg-gradient-to-b from-white/20 to-white/10 text-black p-4 rounded-3xl w-[calc(100vw-16px)] md:w-[540px] lg:w-[420px] lg:h-[180px] relative transition-all duration-700 delay-500 border-2 border-gray-300/40 lg:flex lg:items-center" data-search-title="About — Overview">
        ...
        <DraggableCard id="card2" position={positions.card2} isDraggingDisabled={isMobile}>
          <div className="backdrop-blur-xl bg-gradient-to-b from-white/20 to-white/10 text-black p-4 rounded-3xl w-[calc(100vw-16px)] md:w-[540px] lg:w-[420px] relative transition-all duration-700 delay-700 hidden [@media(min-width:768px)]:block [@media(min-height:770px)_and_(max-width:767px)]:block border-2 border-gray-300/40 lg:flex lg:items-center" data-search-title="About — Interests">
