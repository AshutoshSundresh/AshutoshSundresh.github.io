...
export default function HeroSection() {
  ...
  return (
    <div id="hero-section" className="relative h-[100dvh] flex flex-col items-center justify-center bg-white p-4 md:p-8 snap-start snap-always">
      ...
      <div className="max-w-4xl mx-auto relative z-10" data-search-title="Hero — Header">
        <div className="text-center">
          ...
          <div className="flex flex-wrap items-center justify-center text-center md:text-left md:justify-start gap-2 mt-2" data-search-title="Hero — Tagline">
            <span className="text-5xl md:text-6xl">
              ...
              <span className="font-array text-[50px] md:text-[60px] animate-gradient bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 text-transparent bg-clip-text">Computer Science major</span>
            </span>
          ...
          <div className="flex justify-center gap-1 mt-8" data-search-title="Social links">
            <a href="https://twitter.com/asundresh" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-gray-600 rounded-md transition-all duration-300 bg-transparent hover:animate-button-gradient hover:bg-gradient-to-r hover:from-gray-50/60 hover:via-white/40 hover:to-gray-50/60 hover:text-gray-900 active:from-gray-100/80 active:via-gray-50/60 active:to-gray-100/80 active:transform active:translate-y-px hover:shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] font-light tracking-wide">X</a>
            <a href="https://github.com/ashutoshsundresh" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-gray-600 rounded-md transition-all duration-300 bg-transparent hover:animate-button-gradient hover:bg-gradient-to-r hover:from-gray-50/60 hover:via-white/40 hover:to-gray-50/60 hover:text-gray-900 active:from-gray-100/80 active:via-gray-50/60 active:to-gray-100/80 active:transform active:translate-y-px hover:shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] font-light tracking-wide">GitHub</a>
            <a href="https://linkedin.com/in/asund" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-gray-600 rounded-md transition-all duration-300 bg-transparent hover:animate-button-gradient hover:bg-gradient-to-r hover:from-gray-50/60 hover:via-white/40 hover:to-gray-50/60 hover:text-gray-900 active:from-gray-100/80 active:via-gray-50/60 active:to-gray-100/80 active:transform active:translate-y-px hover:shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] font-light tracking-wide">LinkedIn</a>
          ...
          <div className="flex justify-center mt-1 sm:mt-6" data-search-ignore="true">
            <button onClick={scrollToNext} className="bg-[#2A2A2A]/90 hover:bg-[#2A2A2A] text-[#CCCCCC] hover:text-white px-4 py-2 rounded-full text-sm transition-all duration-300 backdrop-blur-sm" aria-label="Scroll to next section">↓ <span className="px-2">More</span></button>
          </div>
        </div>
      </div>
