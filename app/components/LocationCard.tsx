...
export default function LocationCard() {
  ...
  return (
    <>
      <div className="backdrop-blur-xl bg-gradient-to-b from-white/20 to-white/10 dark:from-white/10 dark:to-white/5 text-black dark:text-dark-primary rounded-3xl w-[calc(100vw-16px)] md:w-[540px] lg:w-[420px] lg:h-[180px] lg:translate-y-[calc(2vw)] relative transition-all duration-700 delay-900 border-2 border-gray-300/40 dark:border-dark-primary overflow-hidden" data-search-title="Location — Map">
        <div className="relative z-10 overflow-hidden h-full flex flex-col">
          ...
          <div className="px-4 py-2 text-center flex-1 flex items-center justify-center">
            {loading ? (
              <p className="text-gray-600 dark:text-dark-secondary text-sm italic">
                Calculating distance...
              </p>
            ) : distance !== null ? (
              <p className="text-gray-900 dark:text-dark-primary text-sm flex items-center justify-center gap-1">
