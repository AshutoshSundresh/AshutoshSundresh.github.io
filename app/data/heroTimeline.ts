...
const RAW: HeroTimelineEntry[] = [
  ...
  { sortKey: '2026-06-20', sentence: 'Went to Newport, Rhode Island and saw some cool old mansions.', navPath: TAB.activities },
  { sortKey: '2026-06-18', sentence: 'Saw the WaterFire bonfires along the rivers in downtown Providence, Rhode Island.', navPath: TAB.activities },
  { sortKey: '2026-06-15', sentence: 'Attended Brown University Systems Week; eBPF, GPU performance, supply-chain security, and Rust privacy analysis.', navPath: TAB.education },
  ...
  { sortKey: '2026-05-10', sentence: 'Went to the LA Hacks Indio retreat at a vacation-home Airbnb.', navPath: TAB.activities },
  ...
  { sortKey: '2026-02-01', sentence: 'Joined UCLA PSSL under Prof. Kallas researching PGO compiler artifact reuse for serverless runtimes.', navPath: TAB.experience },
  ...
  { sortKey: '2025-08-27', sentence: 'Volunteered cleaning the coastal trail near the USS San Francisco Memorial with my Harvey team.', navPath: TAB.activities },
  { sortKey: '2025-08-25', sentence: 'Kayaked in Sausalito with the other Kleiner Perkins fellows.', navPath: TAB.activities },
  { sortKey: '2025-08-08', sentence: 'Caught an SF Giants game from a VIP box at Oracle Park, courtesy of Kleiner Perkins.', navPath: TAB.activities },
  { sortKey: '2025-08-01', sentence: 'Named a William F. Sharpe Technology Fellow through UCLA Alumni programs.', navPath: TAB.awards },
  { sortKey: '2025-07-30', sentence: 'Cleared an escape room at the Palace of Fine Arts in under an hour, then saw the Tech Roast Show.', navPath: TAB.activities },
  { sortKey: '2025-07-17', sentence: 'Invited to OpenAI gpt-oss launch day; got to meet Sam Altman.', navPath: TAB.activities },
  { sortKey: '2025-07-13', sentence: 'Saw Phantogram at Stern Grove in San Francisco.', navPath: TAB.activities },
  { sortKey: '2025-06-29', sentence: 'Drove the Marin Headlands in a Lexus LC 500 from Cavallo Point; found whale bones on the black sand beach.', navPath: TAB.activities },
  { sortKey: '2025-06-22', sentence: 'Sailed around Alcatraz on a yacht in the SF Bay.', navPath: TAB.activities },
